        ...
        <div class="row row-sm">
          <div class="col-lg-8">
            ...
            <div class="card bd-primary mg-t-20">
              <div class="card-header bg-primary tx-white" id="all_courier">All delivered package</div><?php
                    // Include config file
                    ...
                    $sql = "SELECT id, track_code, sen_fname, rec_fname, date_received, status  FROM users WHERE status ='delivered'";
